                    ...
                    return`<div class="dropdown">
                            <button class="btn btn-light-success btn-sm" type="button" data-bs-toggle="dropdown" aria-expanded="false">Actions <i class="ki-duotone ki-down fs-5 ms-1"></i></button>
                                <ul class="dropdown-menu menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4">
                                    ...
                                    <li>
                                        <div class="menu-item px-3">
                                            <a href="javascript:void(0)" class="menu-link px-3 fs-7 btn ${btn_disposisi}" id="disposisi_surat_masuk" data-id_surat_masuk='${data}' data-url="{{asset('/uploads/surat_masuk/${file}')}}">Disposisi</a>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="menu-item px-3">
                                            <a href="javascript:void(0)" class="menu-link px-3 fs-7 btn ${btn_tindaklanjut}" id="tindak_lanjut_surat_masuk" data-id_surat_masuk='${data}' data-url="{{asset('/uploads/surat_masuk/${file}')}}">Tindak lanjut</a>
                                        </div>
                                    </li>
                                </ul>
                            </div>`;
