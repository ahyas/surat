...
<div class="content flex-column-fluid" id="kt_content">
    ...
    <!--Start::detail-->
    <div class="modal fade" id="kt_modal_naikan" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable modal-fullscreen">
            <div class="modal-content">
                <!--begin::Modal header-->
                <div class="modal-header">
                    <div id="naikan-title"></div>
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <div class="col-lg-6">
                                <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                    <div style="left: 0; width: 100%; height: 0; position: relative; padding-bottom: 129.4118%;">
                                        <iframe id="preview_naikan" src="#" style="top: 0; left: 0; width: 100%; height: 100%; position: absolute; border: 0;" allowfullscreen></iframe>
                                    </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <form id="kt_modal_naikan_form" name="add_naikan_form" class="form" action="#" >
                                {{csrf_field()}}
                                    <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                        <div id="naikan-notification"></div>
                                        ...
                                        <input type="hidden" name="naikan-id_surat_masuk" class="form-control" />
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <textarea class="form-control form-control-solid" placeholder="Catatan " id="naikan-catatan" name="naikan-catatan" rows="3"></textarea>
                                        </div>
                                    </div>
                                    <div class="text-center pt-10">
                                        <button type="button" id="btn-cancel" class="btn btn-light-danger" data-bs-dismiss="modal">Cancel</button>
                                        <button type="submit" class="btn btn-primary naikan_simpan" id="naikan_simpan" data-kt-indicator="off">
...
$(document).ready(function(){
                    ...
                    return`<div class="dropdown">
                            <button class="btn btn-light-success btn-sm" type="button" data-bs-toggle="dropdown" aria-expanded="false">Actions <i class="ki-duotone ki-down fs-5 ms-1"></i></button>
                                <ul class="dropdown-menu menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4">
                                    ...
                                    <li>
                                        <div class="menu-item px-3">
                                            <a href="javascript:void(0)" class="menu-link px-3 fs-7 btn ${btn_naikan}" id="naikan_surat_masuk" data-id_surat_masuk='${data}' data-url="https://docs.google.com/viewer?embedded=true&url=https://simisol.pta-papuabarat.go.id/public/uploads/surat_masuk/${file}">Naikan</a>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="menu-item px-3">
                                            <a href="javascript:void(0)" id="disposisi_surat_masuk" class="menu-link px-3 fs-7 btn ${btn_disposisi}" data-id_surat_masuk='${data}' data-url="https://docs.google.com/viewer?embedded=true&url=https://simisol.pta-papuabarat.go.id/public/uploads/surat_masuk/${file}">Disposisi</a>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="menu-item px-3">
                                            <a href="javascript:void(0)" class="menu-link px-3 fs-7 btn ${btn_tindaklanjut}" id="tindaklanjut_surat_masuk" data-id_surat_masuk='${data}' data-url="https://docs.google.com/viewer?embedded=true&url=https://simisol.pta-papuabarat.go.id/public/uploads/surat_masuk/${file}">Tindak lanjut</a>
                                        </div>
                                    </li>
                                </ul>
                            </div>`;
    ...
    $("#naikan_simpan").click(function(e){
        e.preventDefault();
        setButtonSpinner(".naikan_simpan", "on");
        $.ajax({
            url     :"{{route('transaksi.surat_masuk.naikan.kirim')}}",
            type    :"POST",
            dataType:"JSON",
            data    : $("#kt_modal_naikan_form").serialize(),
            dataType: "JSON",
            success:function(data){
                console.log(data);
                if(!data.success){
                    ...
                    document.getElementById("naikan-notification").innerHTML = "<div class='alert alert-danger d-flex align-items-center p-5' id='naikan-notification'><i class='ki-duotone ki-shield-tick fs-2hx text-danger me-4'><span class='path1'></span><span class='path2'></span></i><div class='d-flex flex-column'><h4 class='mb-1 text-danger'>Oops! Something went wrong!</h4>"+err_catatan+err_tujuan+"</div></div>";  

                    setButtonSpinner(".naikan_simpan", "off");
