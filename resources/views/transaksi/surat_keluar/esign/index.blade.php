        ...
        [
            ...
            {data:"file",
                mRender:function(data, type, full){
                    ...
                    return`<a href='javascript:void(0)' data-filename='${data}' id="lampiran" data-id_surat='${full['id_surat']}' data-url="{{asset('/uploads/surat_keluar/${data}')}}"><span class="badge badge-light-secondary">Berkas</span></a>`;
                }
            },
            {data:"dibuat_oleh"}
        ]
